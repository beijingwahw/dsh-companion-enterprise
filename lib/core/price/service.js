 ...
 */
export function resolveScheduledTable(base, scheduled, atMs) {
    if (scheduled === undefined || beijingDayKey(atMs) < scheduled.effective)
        return base;
...
export class PriceService {
    ...
    async fetchVendorTable(vendorId) {
        ...
        if (info === undefined)
            throw new Error(`companion-pricing: unknown vendor ${vendorId}`);
