...
export const VENDOR_IDS = ['deepseek', 'zhipu', 'moonshot', 'qwen', 'doubao', 'minimax', 'ernie'];
 ...
 */
export function vendorInfoOf(vendorId) {
    return Object.hasOwn(VENDORS, vendorId) ? VENDORS[vendorId] : undefined;
}
