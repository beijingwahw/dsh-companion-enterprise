 ...
 */
export declare function analyzeFrontier(inputs: readonly FrontierInput[]): FrontierReport;
/** 延迟档位先验（毫秒）：无金丝雀实测时按档位估计。 */
export declare const LATENCY_TIER_PRIOR_MS: Readonly<Record<'fast' | 'balanced' | 'slow', number>>;
